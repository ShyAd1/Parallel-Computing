...
int main()
{
    int semaforo_fila2 = semget(ftok("Archivo", '2'), 1, 0);
    down(semaforo_fila2); // Espera a que el proceso principal haga 'up'
    ...
    for (int i = 0; i < 9; i++)
    {
        ...
        resultado[2] *= memoria_compartida[i];
        // printf("\nEl resultado parcial de la tercera fila es: %d\n", resultado[2]);
    ...
    printf("\nEl resultado de la tercera fila con PID %d de la multiplicacion es: %d\n", getpid(), resultado[2]);
